...
public class SimpleMenuItem implements MenuItem {
     ...
     *
     * @param menu            Reference to the containing menu
     * @param id              Unique menu item id
     * @param order           Menu item order
     * @param title           Full title for this menu item
     * @param actionBarHelper ActionBarHelper for enable state change callbacks
     */
