...
public class ActionBarHelperBase extends ActionBarHelper {
     ...
     *
     * @param item MenuItem to create as ActionBar icon
     */
    ...
    private class HomeButtonLayout extends LinearLayout {
         ...
         *
         * @param context Context used to create the layout
         */
        @SuppressLint("InlinedApi")
    ...
    private class WrappedMenuInflater extends MenuInflater {
        ...
        /**
         * @param context  Context used to inflate menus
         ...
         *
         * @param menuResId Menu (by resource id) to parse for ActionBar metadata
         */
        @SuppressLint("InlinedApi")
