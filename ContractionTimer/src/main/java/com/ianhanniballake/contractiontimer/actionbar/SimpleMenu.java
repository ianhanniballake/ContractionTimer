...
public class SimpleMenu implements Menu {
     ...
     *
     * @param context         Context used to create menu items
     * @param actionBarHelper ActionBarHelper for state change callbacks
     */
     ...
     *
     * @param items Existing menu items
     * @param order Order of the new menu item
     ...
     *
     * @param itemId Unique Item Id for the menu item
     * @param order  The order of the menu item
     * @param title  CharSequence title of the menu item
